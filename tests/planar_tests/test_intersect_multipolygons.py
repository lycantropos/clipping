...
def test_absorption_identity(multipolygons_pair: MultipolygonsPair) -> None:
    ...
    result = intersect_multipolygons(left_multipolygon, unite_multipolygons(left_multipolygon,
                                                                            right_multipolygon))
...
def test_commutativity(multipolygons_pair: MultipolygonsPair) -> None:
    ...
    assert result == intersect_multipolygons(right_multipolygon, left_multipolygon)
...
def test_associativity(multipolygons_triplet: MultipolygonsTriplet) -> None:
    ...
    result = intersect_multipolygons(intersect_multipolygons(left_multipolygon, mid_multipolygon),
                                     right_multipolygon)

    assert result == intersect_multipolygons(left_multipolygon,
                                             intersect_multipolygons(mid_multipolygon, right_multipolygon))
...
def test_difference_operand(multipolygons_triplet: MultipolygonsTriplet
    ...
    result = intersect_multipolygons(subtract_multipolygons(left_multipolygon, mid_multipolygon),
                                     right_multipolygon)

    assert result == subtract_multipolygons(intersect_multipolygons(left_multipolygon, right_multipolygon),
                                            mid_multipolygon)
...
def test_distribution_over_union(multipolygons_triplet: MultipolygonsTriplet
    ...
    result = intersect_multipolygons(left_multipolygon, unite_multipolygons(mid_multipolygon,
                                                                            right_multipolygon))

    assert result == unite_multipolygons(intersect_multipolygons(left_multipolygon, mid_multipolygon),
...
def test_reversals(multipolygons_pair: MultipolygonsPair) -> None:
    ...
    assert result == intersect_multipolygons(reverse_multipolygon_holes(left_multipolygon),
                                             right_multipolygon)
    assert result == intersect_multipolygons(left_multipolygon,
