...
def test_expressing_intersection_as_difference(
    ...
    result = subtract_multipolygons(left_multipolygon, subtract_multipolygons(left_multipolygon,
                                                                              right_multipolygon))

    assert are_multipolygons_similar(result, intersect_multipolygons(left_multipolygon,
                                                                     right_multipolygon))
...
def test_difference_subtrahend(multipolygons_triplet: MultipolygonsTriplet
    ...
    result = subtract_multipolygons(left_multipolygon, subtract_multipolygons(mid_multipolygon,
                                                                              right_multipolygon))
...
def test_intersection_minuend(multipolygons_triplet: MultipolygonsTriplet
    ...
    result = subtract_multipolygons(intersect_multipolygons(left_multipolygon, mid_multipolygon),
                                    right_multipolygon)

    assert result == intersect_multipolygons(left_multipolygon, subtract_multipolygons(mid_multipolygon,
                                                                                       right_multipolygon))
...
def test_intersection_subtrahend(
    ...
    result = subtract_multipolygons(left_multipolygon, intersect_multipolygons(mid_multipolygon,
                                                                               right_multipolygon))
...
def test_union_subtrahend(multipolygons_triplet: MultipolygonsTriplet) -> None:
    ...
    result = subtract_multipolygons(left_multipolygon, unite_multipolygons(mid_multipolygon,
                                                                           right_multipolygon))

    assert are_multipolygons_similar(result,
                                     intersect_multipolygons(subtract_multipolygons(left_multipolygon,
                                                                                    mid_multipolygon),
                                                             subtract_multipolygons(left_multipolygon,
                                                                                    right_multipolygon)))
...
def test_reversals(multipolygons_pair: MultipolygonsPair) -> None:
    ...
    assert are_multipolygons_similar(
            result, subtract_multipolygons(reverse_multipolygon(left_multipolygon),
                                           right_multipolygon))
    assert result == subtract_multipolygons(
            left_multipolygon, reverse_multipolygon(right_multipolygon))
    assert are_multipolygons_similar(
            result, subtract_multipolygons(reverse_multipolygon_borders(left_multipolygon),
                                           right_multipolygon))
    assert result == subtract_multipolygons(
            left_multipolygon,
            reverse_multipolygon_borders(right_multipolygon))
    assert are_multipolygons_similar(
            result, subtract_multipolygons(reverse_multipolygon_holes(left_multipolygon),
                                           right_multipolygon))
    assert result == subtract_multipolygons(left_multipolygon,
                                            reverse_multipolygon_holes(right_multipolygon))
    assert are_multipolygons_similar(
            result,
            subtract_multipolygons(reverse_multipolygon_holes_contours(left_multipolygon),
                                   right_multipolygon))
    assert result == subtract_multipolygons(
            left_multipolygon,
